...
<body class="nav-sm" onLoad="function finicio()">
                                ...
                                <div class="x_content" align="center">
                                    ...
                                    <div id="accordion">
                                        ...
                                        <form name="form3" action="" method="post">
                                          <input type="hidden" name="identi" value="<?php echo $row['Per_Id']; ?>"/>                  						<input type="hidden" name="eli_foto" value="si"/>
    ...
    $("<div>porfavor cargar solo archivos jpg o png.</div>").dialog({
       ...
       <?php foreach ($personalid as $row){?>
                                        <tr>
                                    	<td align="center"><input type="hidden" name="eli_foto" value="si"/>
                                    	  Nombre:</td>
