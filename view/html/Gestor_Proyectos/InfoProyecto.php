...
$projects->insert_comment();
  ...
  $ditos = $projects->miembros_Proyecto($nom);
   $detos = $projects->boton_Aprobar($nom);
   $dotos = $projects->boton_Eliminar($nom);
   $datas = $projects->boton_EliminarDos($nom);
...
?>
                       ...
                       <tr>
                       	  <td width="45%"><b>MIEMBROS DEL PROYECTO:</b></td>
                          <td></td>
                       </tr>
                       <tr>
                           <?php
...
<img src="reader_icon_special.jpg" alt="Descargar Adobe Reader" width="32" height="32" style="border: none;" /></a> 
      ...
      <?php  endforeach;?>                                                              
                              ...
                              <div class="grid_2" id="aprobarg"><button type="button" id="<?= $t['Pro_Codigo'];?>" class="btn btn-round btn-success aprobarg"><span class="glyphicon glyphicon-thumbs-up"></span> Aprobar</button></div>
                              <?php
	endforeach;
?>  
     </td><td>
     <?php
										foreach ($dotos as $t):  
										?>
      <div class="grid_2" id="eliminarpr"><button type="button" id="<?php echo $t['Pro_Codigo'];?>" class="btn btn-round btn-danger eliminarpr"><span class="glyphicon glyphicon-trash"></span> Eliminar</button></div>                              
