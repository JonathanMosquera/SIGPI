...
$data = $projects->proyectos_aprobadosGL();
...
<!---------------------------------------------------------------------------------------------------------------------------->                  <div align="center"> <button class="btn btn-default source" id="reporte"><i class="fa fa-file-pdf-o"></i> Reporte de Proyectos</button></div>
...
<table id="ghatable" class="display table table-bordered table-stripe table-condensed table-responsive responsive-utilities jambo_table bulk_action" cellspacing="0" width="100%">
     ...
     <tbody>
          ...
          if(sizeof($data) > 0){
               foreach ($data as $row){
                    ?>
                    <tr  onclick="window.location.href='InfoProyecto.php?m=<?php echo $row['Pro_Codigo'];?>'">
